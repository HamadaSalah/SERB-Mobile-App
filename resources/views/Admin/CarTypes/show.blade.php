...
@section('title', 'تفاصيل انواع الشاحنه')
@section('content')
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3 t-header" style="display: inline-block;">تفاصيل انواع الشاحنه</h6>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" action="{{route('admin.cartypes.store')}}"> 
                @csrf
                <div class="mb-3">
